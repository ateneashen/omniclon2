# Guía de usuario para novatos — OmniClon 2 v1.1.2
...
7. Se abrirá la ventana de **OmniClon 2**. Arriba verás el nombre y la versión `v1.1.2`.
...
Si es una nueva versión (por ejemplo v1.1.2), también:

```bash
git tag -a v1.1.2 -m "OmniClon 2 v1.1.2"
