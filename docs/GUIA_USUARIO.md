# Guía de usuario para novatos — OmniClon 2 v1.2.0
...
7. Se abrirá la ventana de **OmniClon 2**. Arriba verás el nombre y la versión `v1.2.0`.
...
Si es una nueva versión (por ejemplo v1.2.0), también:

```bash
git tag -a v1.2.0 -m "OmniClon 2 v1.2.0"
